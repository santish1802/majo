...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header">
                        <h5><i class="fas fa-search"></i> Buscar y Añadir</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card mt-3">
                    <div class="card-header">
                        <h5><i class="fas fa-shopping-cart"></i> Carrito de Pedidos</h5>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-6">
                                <label for="tipoUbicacion" class="form-label fw-bold text-primary">Tipo de Ubicación</label>
                        ...
                        <button onclick="crearPedido()" class="btn btn-success w-100"><i class="fas fa-plus"></i> Crear Pedido</button>
                        <a href="pedidos.php" class="btn btn-gray w-100 mt-2">
    ...
    <div class="modal fade" id="modalCombo" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalComboTitle">Crear Combo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="comboNombre" class="form-label">Nombre del Combo</label>
                        <input type="text" class="form-control" id="comboNombre" required>
                    </div>
                    <div class="mb-3">
                        <label for="comboPrecio" class="form-label">Precio del Combo</label>
                        <input type="number" class="form-control" id="comboPrecio" step="0.01" required>
                    </div>
                    <hr>
                    <h6 class="mb-3">Selecciona los productos del combo:</h6>
                    <div id="listaProductosCombo" style="max-height: 250px; overflow-y: auto;">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" onclick="guardarCombo()">Guardar Combo</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
                        ...
                        <div class="carrito-item">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-end">
                                    ...
                                    <div class="btns-pc">
                                        <button class="btn px-4 btn-custom btn-dark" onclick="modificarItem(${item.id})"><i class="fa-regular fa-pen-to-square me-2"></i></i>Precio</button>
                            ...
                            <div class="btns-mv d-flex justify-content-between align-items-center mt-2 gap-2">
                                <button class="btn px-4 btn-custom flex-fill btn-dark" onclick="modificarItem(${item.id})"><i class="fa-regular fa-pen-to-square me-2"></i></i>Precio</button>
        ...
        function cambiarCantidad(itemId, cambio) {
            ...
            if (item) {
                ...
                if (nuevaCantidad <= 0) {
                    ...
                    // Si reducimos la cantidad y había productos modificados, ajustar
        ...
        // Nueva función para aplicar modificación rápida usando el botón principal
        function aplicarModificacionRapida(itemId) {
            ...
            // Determinar qué tipo de modificación aplicar basado en qué campo tiene valor
            if (precioFijoInput.value && precioFijoInput.value.trim() !== '') {
                ...
                // Por defecto aplicar en soles, pero se podría hacer más inteligente
        ...
        // Función separada para cambiar cantidad específicamente en el modal de modificación
        function cambiarCantidadModificar(cambio, maxCantidad) {
            ...
            // Validar límites específicos del modal
        ...
        // Función para cambiar la cantidad en el modal con botones +/-
        function cambiarCantidadModal(inputId, cambio, min, max) {
            const input = document.getElementById(inputId);
            const display = document.getElementById(inputId + 'Display');

            let valorActual = parseInt(input.value) || min;
            let nuevoValor = valorActual + cambio;
        ...
        function calcularTotales() {
            ...
            // Calcular subtotal considerando precios modificados por cantidad
    ...
    numeroMesa.classList.remove('is-invalid');
            ...
            const pedido = {
                items: carrito.map(item => ({
                    id: item.producto_id || item.combo_id,
                    tipo: item.tipo,
            ...
            fetch('api.php', {
                ...
                .catch(error => {
                    ...
                    alert('Error de conexión al intentar crear el pedido.');
                });
        }
