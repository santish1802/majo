...
<body>
    ...
    <script>
        ...
        function exportarProductosAWhatsApp() {
            ...
            let mensaje = "*Reporte de Stock de Productos:*\n\n";

            datos.forEach(item => {
                const nombre = item.nombre;
                const stock = item.stock_actual;
                mensaje += `- ${nombre}: ${stock}\n`;
            });

            // Número de WhatsApp (51 es el código de país de Perú)
            const numeroWhatsApp = "51956263107"; 
            
            // Codificar el mensaje para URL. \n se convierte en %0A por encodeURIComponent
