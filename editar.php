    ...
    <script>
        ...
        function cargarDatosPedido(info, items) {
            ...
            carrito = items.map(item => ({
                ...
                tipo: item.combo_id ? 'combo' : 'producto',
        ...
        // Función de búsqueda de productos (igual que en index.php)
        ...
        // Las funciones de manipulación del carrito son idénticas a index.php
...
// Función completa para modificar items (agregar al editar.php)
